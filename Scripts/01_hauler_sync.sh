...
# 00_hauler_sync.sh — Pull all artifacts into the local hauler store
#
# Run this on the admin node (nuc-00) BEFORE going airgap.
...
---
# AUTO-GENERATED by 00_hauler_sync.sh — do not edit by hand
